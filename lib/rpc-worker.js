...
class RPCWorker {
    ...
    processProcedure(procedureMessage) {
        ...
        try {
            ...
            this.reply(procedureMessage, { error: new VError(err, msg) });
        }
        ...
        if (procedure) {
            ...
            logError('RPC-Worker', msg);
            this.reply(procedureMessage, { error: new VError(msg) });
        }
    }
    ...
    reply(procedureMessage, response) {
        ...
        try {
            ...
            logError('RPC-Worker', msg);
            responseBuffer = new BSON().serialize({ error: new VError(err, msg) }, false, true);
        }
